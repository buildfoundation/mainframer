...
mod tests {
    ...
    fn format_duration_1_minute_1_5_second() {
        assert_eq!(
            format_duration(Duration::from_millis(61500)),
            "1 minute 1 second"
        );
    }
    ...
    fn format_duration_1_minute_2_seconds() {
        assert_eq!(
            format_duration(Duration::from_secs(62)),
            "1 minute 2 seconds"
        );
    }
    ...
    fn format_duration_2_minutes() {
        assert_eq!(
            format_duration(Duration::from_secs(120)),
            "2 minutes 0 seconds"
        );
    }
    ...
    fn format_duration_2_minutes_1_second() {
        assert_eq!(
            format_duration(Duration::from_secs(121)),
            "2 minutes 1 second"
        );
    }
    ...
    fn format_duration_2_minutes_2_seconds() {
        assert_eq!(
            format_duration(Duration::from_secs(122)),
            "2 minutes 2 seconds"
        );
    }
    ...
    fn format_duration_1_hour_1_5_second() {
        assert_eq!(
            format_duration(Duration::from_millis(3601 * 1000 + 500)),
            "1 hour 0 minutes"
        );
    }
    ...
    fn format_duration_1_hour_2_seconds() {
        assert_eq!(
            format_duration(Duration::from_secs(3602)),
            "1 hour 0 minutes"
        );
    }
    ...
    fn format_duration_1_hour_1_minute_1_5_second() {
        assert_eq!(
            format_duration(Duration::from_millis(3661 * 1000 + 500)),
            "1 hour 1 minute"
        );
    }
    ...
    fn format_duration_1_hour_1_minute_2_seconds() {
        assert_eq!(
            format_duration(Duration::from_secs(3662)),
            "1 hour 1 minute"
        );
    }
    ...
    fn format_duration_1_hour_2_minutes() {
        assert_eq!(
            format_duration(Duration::from_secs(3720)),
            "1 hour 2 minutes"
        );
    }
    ...
    fn format_duration_1_hour_2_minutes_1_second() {
        assert_eq!(
            format_duration(Duration::from_secs(3721)),
            "1 hour 2 minutes"
        );
    }
    ...
    fn format_duration_1_hour_2_minutes_2_seconds() {
        assert_eq!(
            format_duration(Duration::from_secs(3722)),
            "1 hour 2 minutes"
        );
    }
}
